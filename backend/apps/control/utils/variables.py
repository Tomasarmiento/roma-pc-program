...
"MA2_I_DR_U_BP_2_SR","MA2_I_DR_D_BP_1_SA","MA2_I_DR_D_BP_1_SR","MA2_I_DR_D_BP_2_SA","MA2_I_DR_D_BP_2_SR","MA2_I_OB","MA2_I_EMS","Emergency","Robot_IDLE",'M_PRG_AUT_SEM',
...
MSG_ERROR_CODIFICATION = {
    ...
    '.r_manualmode':'error robot en modo manual (fuerza reset)',
    ...
    '.r_gp1_free':'gripper 1 libre',
    '.r_gp2_free':'gripper 2 libre',
    ...
    '.ch1_nsense_adv':'error okuma 1 neumatica avanzó',
    ...
    '.max_block_error':'error bloqueo pallet',
